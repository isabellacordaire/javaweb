...
var produtos=[
{"livros" : ["BRANCA DE NEVE", "A BELA MOÇA", "O GUIA", "DR.
OZZY", "PEQUENO IRMÃO"],
PIE", "HANNIBAL"],
"filmes" : ["DEADPOOL", "GODZILLA", "LAGOA AZUL", "AMERICAN
"musicas": ["ZZ TOP", "BLACK SABBATH", "AC DC", "PRIMUS",
"MOLEJO"],
...
window.alert("Temos "+ titulo.value +" em nosso estoque
}
enc++;
}
...
window.alert("Encontramos alguns produtos nessa categoria LIVROS:
"+produtos[0].livros);
}
else if(nome == "FILMES" || nome == "FILME"){
window.alert("Encontramos alguns produtos na categoria FILMES:
"+produtos[0].filmes);
}
else if(nome == "MUSICAS" || nome == "MUSICA"){
window.alert("Encontramos alguns produtos nessa categoria MUSICAS:
"+produtos[0].musicas);
}
else if(nome == "GAMES" || nome == "JOGOS"){
window.alert("Encontramos alguns produtos nessa categoria GAMES:
"+produtos[0].games);
}
else if(enc == 0){
