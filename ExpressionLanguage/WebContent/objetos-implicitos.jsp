...
<body>
	Este exemplo ilustra alguns dos objetos implícitos disponíveis na
	Expression Language. Os seguintes objetos estão implicitamente
	...
	<table cellpadding="0" cellspacing="0" border="1"
		...
		<tr>
			...
			<td>Atributo no escopo da Aplicação</td>
			<td>Valor</td>
	...
	<blockquote>
		<u><b>Alterar Parâmetro</b></u>
		<form action="objetos-implicitos.jsp" method="GET">
